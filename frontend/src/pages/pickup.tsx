      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <a
              href="https://readdy.ai/home/b4383bb1-e854-4755-a6c1-8a3747727243/c88ec955-c0d7-47a6-adb1-b5e889caabd6"
              data-readdy="true"
              ...
              {isMenuOpen && (
                <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-100 py-2 z-50">
                  ...
                  <button
                    ...
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <i className="fas fa-leaf text-gray-400 w-5"></i>
                    {t.greenPoints}
                  </button>
                  <button
                    className="w-full px-4 py-2 text-left text-gray-700 hover:bg-gray-50 flex items-center gap-3"
                  ...
                  <button
                    className="w-full px-4 py-2 text-left text-red-600 hover:bg-gray-50 flex items-center gap-3"
                    onClick={() => setIsMenuOpen(false)}
                  >
